...
No reference to Project2 is kept — plugins cannot reach internal project
...
from panoptic2.models.action_models import FunctionDescription
...
class PluginProjectInterface:
    ...
    # ------------------------------------------------------------------
    # Internal DB helpers — same open/close-per-call pattern as Project2
    # ------------------------------------------------------------------

...
function handleClick(e: Event) {
    if(popupElem.value.contains(e.target)) {
        console.log("contain")
        // e.preventDefault()
        // e.stopPropagation()
    }
...
<template>
    <div class="p-0 m-0">
        ...
        <Popper trigger="click-to-open" :force-show="forceVisible" :teleport-props="{to: '#popper-holder'}" @show="onShow" @hide="onHide" ref="popperElem">
            <template #reference>
                <div class="m-0 p-0">
            ...
            <div class="popup bg-white m-0 p-0 rounded overflow-hidden" :class="props.noShadow ? '' : 'shadow2'" style="z-index: 999;" tabindex="0" @keydown.escape="onEsc" ref="popupElem">

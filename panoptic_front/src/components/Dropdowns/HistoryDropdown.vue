...
<template>
    <Dropdown>
        ...
        <template #popup>
            <!-- {{ data.history }} -->
            <div class="p-2">
                <div v-if="data.history.redo.length > maxShow" class="border mb-1 p-1 text-center text-secondary"  style="background-color: #f7f7f7;" >
                ...
                <div class="border mb-1 p-1"  style="background-color: #f7f7f7;" >
                    <div class="d-flex center justify-content-center">
                        <div v-if="undos.length" class="bi bi-arrow-down sb" @click="data.undo"></div>
                        <div v-else class="bi bi-arrow-down text-secondary"></div>
                        <div style="width: 30px;"></div>
                        <div v-if="redos.length" class="bi bi-arrow-up sb" @click="data.redo"></div>
                ...
                <div v-if="data.history.undo.length > maxShow" class="border mb-1 p-1 text-center text-secondary"  style="background-color: #f7f7f7;" >

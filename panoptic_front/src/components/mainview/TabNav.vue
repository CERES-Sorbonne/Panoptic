...
<template>
    <nav>
        <div class="d-flex d-row" style="cursor: pointer;">
            ...
            <div style="margin: 2px;" class=" bb me-3 text-secondary" v-if="panoptic.connectionState?.user" @click="useSocketStore().disconnectUser()"> {{ panoptic.connectionState.user.name }} </div>
